// alert(9+0); // if we try to run this using nodejs it throw erro, it runs only browser (bcz browser works as the whole document)
...
// This is new datatype in JS(ES-JS)
